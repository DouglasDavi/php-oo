...
class daoAutor implements iPage
{
    ...
    { 
        try {
            $statement = Conexao::getInstance()->prepare("SELECT idtb_autores, nomeAutor FROM tb_autores");
   ...
   public function buscaAtt(){            
    ...
    //     (" SELECT u.nomeAutor AS Autor                                                       
    //             FROM tb_livro a
    //                 JOIN 
    //             tb_livro_autor l ON l.tb_livro_idtb_livro = a.idtb_livro        
    //                 JOIN
    //             tb_autores u ON u.idtb_autores = l.tb_autores_idtb_autores ");
    // }
